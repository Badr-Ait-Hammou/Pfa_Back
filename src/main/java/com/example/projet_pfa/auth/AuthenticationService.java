...
import com.example.projet_pfa.config.JwtService;
import com.example.projet_pfa.repository.UserRepository;
import com.example.projet_pfa.token.Token;
import com.example.projet_pfa.token.TokenRepository;
import com.example.projet_pfa.token.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        if (repository.findByEmail(request.getEmail()).isPresent() || repository.findByEmail(request.getEmail()).isPresent()) {
